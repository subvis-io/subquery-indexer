...
export class Staking implements Entity {
    ...
    public startSessionIdx?: number;

    public stakingAmount?: bigint;

    public stakingEraPayout?: bigint;

    public stakingEraRewardPoints?: number;

    public stakingValidatorCount?: number;

    public counterForNominators?: number;

    public counterForValidators?: number;
